...
```{r strike-zone, echo = FALSE, message = FALSE, warning = FALSE, fig.width= 6, fig.height = 4.5}
...
```{r strike-zone-plus, echo = FALSE, message = FALSE, warning = FALSE, fig.width= 6, fig.height = 4.5}
...
*Problem:* wins and losses alone insufficient 

*Problem:* point differential non-generalizable
...
```{r sox-tigers, echo = FALSE, message = FALSE, warning = FALSE, fig.width=7, fig.height=3.8}
...
```{r sox-tigers-spaghetti, echo = FALSE, message = FALSE, warning = FALSE, fig.width= 6, fig.height = 3.5}
...
## Unpredictability, season-to-season

```{r season-sigma, echo = FALSE, fig.width = 5.8, fig.height = 4.4}
...
## Unpredictability, week-to-week


```{r week-sigma, echo = FALSE, fig.width = 5.8, fig.height = 4.4}
p2
```
...
```{r home-advantage, echo = FALSE, fig.width = 5.8, fig.height = 4.4}
...
```{r home-advantage-nba, echo = FALSE, fig.width = 6, fig.height = 4.5}
...
<p class="double">
<img src="herm.png" style="width:250px; height=250px">
</p>
...
<p class="double">
<img src="pats_dolphins.jpg" style="width:250px; height=150px">
</p>
