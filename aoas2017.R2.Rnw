...
Additionally, we assess whether or not our models can generate predictions using the posterior distributions of each parameter that reflect the observed game probabilities. These distributions of predictions, termed posterior predictive distributions, and can be used to both assess model fit and to compare different models.  
