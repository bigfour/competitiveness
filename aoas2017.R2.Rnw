...
labels <- parity %>%
  # hack for labels
  mutate(seed = 15, mean_finish = 3.5, label = "perfect\nparity")

labels2 <- labels %>%
  mutate(seed = 2, mean_finish = 1, label = "predestination")
...
#  geom_point(aes(y = predestination_finish), color = "darkgray") + 
  geom_line(aes(y = predestination_finish), color = "darkgray", linetype = 3) +
#  geom_point(aes(y = parity_finish), color = "darkgray") + 
  geom_line(aes(y = parity_finish), color = "darkgray", linetype = 3) +
  geom_point() + 
  geom_line() +
