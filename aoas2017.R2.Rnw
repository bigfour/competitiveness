...
We conclude by addressing our initial question about the inherent randomness of game outcomes. \hl{Our approach here is not unlike that of} \cite{james1993answering}.  \greg{This sentence feels awkward here.  I think we need to move this earlier in the paper.  }
