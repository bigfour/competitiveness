...
Taken wholly, this suggests that perceived differences in the home advantage between teams in each league are likely not accounted for due to chance alone.
...
In MLB, the Colorado Rockies stand out for having a home advantage larger than the other 29 teams, which boast overlapping credible intervals. 
