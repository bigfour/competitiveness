...
\greg{Figure 6, is missing the solid black line.  } \mike{Shows up on my pdf}
...
\greg{I don't understand step six.  50\% prob of positive or negative? } \mike{Probably a better way to word it, but it's our random error from the initial full model...so plus or minus $\tau$}
