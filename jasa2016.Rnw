...
gg1 <- gg + geom_point(data = datbetas.empty, colour = "grey", alpha = .2,  
                       aes(y=alpha.team.overall, x=rank.within, group = team)) + 
  geom_errorbar(data = datbetas.empty, colour = "grey", alpha = 0.2,
...
#### Note: add in the grey background
