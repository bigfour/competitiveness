...
Ultimately, estimates from Model~(\ref{model.full}) are designed to estimate team quality at any given point in a season. If these estimates more properly assess team quality than other metrics of team success, such as won-loss percentage and point differential, they should more accurately assess future performance, such as how well teams will do over remaining games in a season.  
