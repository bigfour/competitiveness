...
With easily accessible data, worldwide interest, and continuously recurring games, sports provides an excellent framework for testing predictive accuracy and understanding randomness. Although most observers can agree that part of game outcomes are due to chance, because randomness manifests differently in different sports and leagues, cross-sport measurements can be particularly challenging. Most often, researchers analyze wins and losses alone, thereby ignoring the game's final score, or apply technical approaches within a single sport that cannot be extended due to differences in the way games and leagues are structured. We aim to do better.
