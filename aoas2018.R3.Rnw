...
4. We fit Model CHA on each of the three simulated distributions of logit probabilities. This totalled 12 iterations -- one apiece for each of 3 home advantages x 4 leagues. 
...
\begin{figure}[h]
\includegraphics[angle=90, scale = 0.4]{figure/scales_simulated.png}
