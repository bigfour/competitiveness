...
4. We fit Model CHA on each of the three distributions of logit probabilities. This totalled 12 iterations -- one apiece for each of 3 home advantages x 4 leagues. 
