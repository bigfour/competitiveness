...
library(dplyr)
load("/Users/gregorymatthews/Dropbox/competitivenessGit/data/tidy_betas.final.rda")
...
load("/Users/gregorymatthews/Dropbox/competitivenessGit/data/tidy_alphas.final.rda")
