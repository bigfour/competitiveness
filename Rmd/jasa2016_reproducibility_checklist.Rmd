...
- Permissions (demonstrate that author has legitimate access to data): Permission to share a version of the Sports Insights data was obtained via email during January, 2017
...
- Supporting software requirements:
    ...
    - CRAN packages: `tidyverse`, `rjags`, `knitr`
