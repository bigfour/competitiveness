...
- Permissions (demonstrate that author has legitimate access to data): **Mike to fill in**
- Licensing information: **Mike to fill in**
- Link to data: (https://github.com/bigfour/competitiveness/data)
- Data provenance, including identifier or link to original data if different than above: Sports Insights (http://www.sportsinsights.com) **Mike to fill in**
- File format: CSV
- Metadata (including data dictionary): **Argh, we should probably write this out...**
```{r}
glimpse(bigfour)
```
- Version information: **Mike to fill in**
