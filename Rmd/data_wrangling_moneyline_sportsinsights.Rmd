...
library(lubridate)
library(readr)
nhl <- read_csv("../data_raw/NHL.csv")
nba <- read_csv("../data_raw/NBA.csv")
nfl <- read_csv("../data_raw/NFL.csv")
mlb <- read_csv("../data_raw/MLB.csv")
...
nfl_results <- read_csv("../data/NFL_results.csv")
