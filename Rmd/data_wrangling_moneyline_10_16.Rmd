...
library(lubridate)
library(readr)
nhl <- read_csv("datanew/NHL.csv")
nba <- read_csv("datanew/NBA.csv")
nfl <- read_csv("datanew/NFL.csv")
mlb <- read_csv("datanew/MLB.csv")
...
```{r}
mlb_results <- read_csv("Data/MLB_results.csv")
...
mlb_dates[mlb_dates$season == 2012,]$min.date <- 
  parse_date_time("2014-04-04", "ymd")


nhl_results <- read_csv("Data/NHL_results.csv")
nhl.new <- data.frame(season = c(2015, 2016), 
                      min.date = parse_date_time(c("2014-10-08", "2015-10-07"), "ymd"), 
                      max.date = parse_date_time(c("2015-04-11", "2016-04-10"), "ymd"))
...
nba_results <- read_csv("Data/NBA_results.csv")
...
nfl_results <- read_csv("~/Dropbox/Competitiveness/Data/NFL_results.csv")
...
```{r}
bigfour.final <- bigfour
save(bigfour.final, file = "data/bigfour.final.rda", compress = "xz")
```
