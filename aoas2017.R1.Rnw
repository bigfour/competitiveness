...
\hl{The conditions needed to apply our modeling framework are minimal; only paired events, outcome probabilities, and some unit of time are needed. As in our example, actual event outcomes need not be observed.
