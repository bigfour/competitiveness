...
\hl{There are several options for applying or extending our model. Generally, the conditions needed to apply our framework are minimal; only paired events, outcome probabilities, and some unit of time are needed. As in our example, actual event outcomes need not be observed.
