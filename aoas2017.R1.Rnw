...
Ultimately, estimates from Model IHA are designed to estimate team quality at any given point in a season in the absence of factors such as the home advantage and opponent caliber. If these estimates more properly assess team quality than other metrics of team success (e.g., won-loss percentage or point differential), they should more accurately link to future performance, such as how well teams will perform over the remainder of the season. \hl{However, it's admittedly unfair to use $cumulative$ estimates of team strength, as future game outcome information is implicity used to predict those same game outcomes. In this sense, $sequential$ fits may more appropriate for understanding the predictive capability of our state-space models.}
